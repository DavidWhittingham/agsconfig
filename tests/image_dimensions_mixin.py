...
@pytest.mark.parametrize(("height", "ex"), [(1000, None), (None, ValueError), (0, ValueError), (-1, ValueError)])
...
@pytest.mark.parametrize(("width", "ex"), [(1000, None), (None, ValueError), (0, ValueError), (-1, ValueError)])
