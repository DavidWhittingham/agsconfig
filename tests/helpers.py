...
HOSTED_FEATURE_SDDRAFT_COPY = os.path.abspath("{0}/samples/hosted_feature.copy.sddraft".format(os.path.dirname(__file__)))
HOSTED_FEATURE_MAIN_JSON = os.path.abspath("{0}/samples/hosted_feature.main.json".format(os.path.dirname(__file__)))
HOSTED_FEATURE_MAIN_JSON_COPY = os.path.abspath("{0}/samples/hosted_feature.main.copy.json".format(os.path.dirname(__file__)))
HOSTED_FEATURE_INFO_JSON = os.path.abspath("{0}/samples/hosted_feature.itemInfo.json".format(os.path.dirname(__file__)))
HOSTED_FEATURE_INFO_JSON_COPY = os.path.abspath("{0}/samples/hosted_feature.itemInfo.copy.json".format(os.path.dirname(__file__)))
